...
$req = $con -> prepare('INSERT INTO form_visite( dateJ, praticien, date, motif, bilan, medicament, avis_visiteur, id_User) VALUES(:a, :c, :d, :e, :f, :g, :h, :b)'); //insert dans la table utilisateur le pseudo et le message
