				...
				<div id="content" class="carre">
					<div name="bas" style="background-color:#456BD9;color:white;">
						<form name="compterendu" method="post" action="traitement_CR.php?id=<?php echo $data; ?>">
							...
							<label class="titre">BILAN :</label><textarea rows="5" cols="50" name="RAP_BILAN" class="zone"required ></textarea></br>
                            <label class="titre">MEDICAMENT :</label><input type="text"  name="MED_NOM" class="zone" required></input></br>
                            <label class="titre">AVIS : </label><textarea rows="5" cols="50" name="AVIS_VISIT" class="zone" required ></textarea></br>
